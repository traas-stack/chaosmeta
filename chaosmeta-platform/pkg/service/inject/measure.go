...
func initMeasureCommon(ctx context.Context, injectId int, measureType string) error {
	...
	argsInterval := basic.Args{InjectId: injectId, ExecType: ExecMeasureCommon, Key: "interval", KeyCn: "interval", ValueType: "string", Unit: "s,m,h", UnitCn: "s,m,h", Required: true, DescriptionCn: "度量操作执行间隔", Description: "Measuring operation execution interval"}
