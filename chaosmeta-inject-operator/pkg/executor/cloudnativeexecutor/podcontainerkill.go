...
func init() {
	registerCloudExecutor(v1alpha1.PodCloudTarget, "containerkill", &PodContainerKillExecutor{})
}
...
func (e *PodContainerKillExecutor) Inject(ctx context.Context, injectObject, uid, timeout string, args []v1alpha1.ArgsUnit) (string, error) {
	...
	return hostIP, remoteexecutor.GetRemoteExecutor().Inject(ctx, hostIP, "container", "kill", uid, timeout, containers[0].ContainerId, containers[0].ContainerRuntime, nil)
}
