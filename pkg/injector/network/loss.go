...
func (i *LossInjector) Validator() error {
...
func (i *LossInjector) Inject() error {
	if i.Args.Force {
	...
	if i.Args.SrcIp == "" && i.Args.DstIp == "" && i.Args.SrcPort == "" && i.Args.DstPort == "" {
		return utils.AddNetemQdisc(i.Args.Interface, "", FaultLoss, faultArgs)
	}
	...
	if i.Args.Mode == utils.ModeNormal {
		parent := "1:4"
		if err := utils.AddNetemQdisc(i.Args.Interface, parent, FaultLoss, faultArgs); err != nil {
...
func (i *LossInjector) getErrWithUndo(errMsg string) error {
...
func (i *LossInjector) Recover() error {
