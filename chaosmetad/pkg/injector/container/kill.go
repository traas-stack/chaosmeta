...
func init() {
	injector.Register(TargetContainer, FaultContainerKill, func() injector.IInjector { return &KillInjector{} })
}
...
func (i *KillInjector) Inject(ctx context.Context) error {
	...
	return client.KillContainerById(ctx, i.Info.ContainerId)
}
