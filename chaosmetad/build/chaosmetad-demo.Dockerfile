# docker build -t registry.cn-hangzhou.aliyuncs.com/chaosmeta/chaosmetad-demo:v0.3.9 -f chaosmetad-demo.Dockerfile .
From centos:centos7
...
ENV CHAOSMETAD_VERSION=0.3.9 \
    ...
    PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/chaosmeta/chaosmetad-0.3.9:/usr/local/jdk1.8.0_361/bin
